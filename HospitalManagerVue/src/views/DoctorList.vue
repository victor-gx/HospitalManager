    ...
    <el-card>
        ...
        <el-row type="flex">
            <el-col :span="8">
                <el-input v-model="query" placeholder="请输入姓名查询">
                    <el-button slot="append" icon="iconfont icon-r-find" @click="requestDoctors"></el-button>
                </el-input>
            </el-col>
            <el-col :span="4"></el-col>
            <el-col :span="4">
                <el-button type="primary" @click="addFormVisible = true" icon="iconfont icon-r-add"
                    style="font-size: 18px;"> 增加医生</el-button>
            </el-col>
            <el-col :span="4"></el-col>
            <!-- 导入数据 -->
            <!-- <el-col :span="2">
            ...
            <el-table-column label="操作" width="200" fixed="right">
                <template slot-scope="scope">
                    <el-button icon="iconfont icon-r-edit" style="font-size: 14px;" type="success"
                        @click="modifyDialog(scope.row.dId)"></el-button>
                    <el-button icon="iconfont icon-r-delete" style="font-size: 14px;" type="danger"
                        @click="deleteDialog(scope.row.dId)"></el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="修改医生信息" :visible.sync="modifyFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="modifyDoctor('ruleForm')">确 定</el-button>
            </div>
        </el-dialog>
    </el-card>
</template>
