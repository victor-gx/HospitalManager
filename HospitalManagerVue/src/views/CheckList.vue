    ...
    <div>
            ...
            <el-row type="flex">
                <el-col :span="6">
                    <el-input v-model="query" placeholder="请输入名称查询">
                        <el-button slot="append" icon="iconfont icon-r-find" @click="requestChecks"></el-button>
                    </el-input>
                </el-col>
                <el-col :span="6"></el-col>
                <el-col :span="6">
                    <el-button type="primary" icon="iconfont icon-r-add" style="font-size: 18px"
            ...
            <el-table :data="checkData" stripe style="width: 100%" border>
                ...
                <el-table-column label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        <el-button icon="iconfont icon-r-edit" style="font-size: 14px" type="success"
                            @click="modifyDialog(scope.row.chId)"></el-button>
                        <el-button icon="iconfont icon-r-delete" style="font-size: 14px" type="danger"
                            @click="deleteDialog(scope.row.chId)"></el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="增加检查项目" :visible.sync="addFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addCheck('ruleForm')">确 定</el-button>
            </div>
        </el-dialog>
        ...
        <el-dialog title="修改检查项目" :visible.sync="modifyFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="modifyCheck('ruleForm')">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
