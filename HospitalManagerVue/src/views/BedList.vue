    ...
    <div>
            ...
            <el-row type="flex">
                <el-col :span="6">
                    <el-input v-model="query" placeholder="请输入患者id查询">
                        <el-button slot="append" icon="iconfont icon-r-find" @click="requestBeds"></el-button>
                    </el-input>
                </el-col>
                ...
                <el-table-column label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        <el-button icon="iconfont icon-r-edit" style="font-size: 14px" type="success"
                            @click="deleteDialog(scope.row.bId)"></el-button>
                        <el-button icon="iconfont icon-r-delete" style="font-size: 14px" type="danger"
                            @click="emptyDialog(scope.row.bId)"></el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="增加床位" :visible.sync="addFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addBed('ruleForm')">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
