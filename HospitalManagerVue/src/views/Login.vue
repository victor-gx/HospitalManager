<template>
    <div class="login-index" :style="backgroundDiv">
        <div class="mid-index">
            <i style="top: 40px; font-size: 28px; left: 20px; position: absolute" class="iconfont icon-r-love">
                登录医院管理系统
            </i>
            <el-form :model="loginForm" :rules="loginRules" ref="ruleForm" class="loginForm">
                ...
                <el-form-item class="btns">
                    ...
                    <el-button type="info" @click="registerFormVisible = true" icon="iconfont icon-r-add">
                        注册新账号</el-button>
                </el-form-item>
            </el-form>
        </div>
                ...
                if (valid) {
                    if (this.role === "管理员") {
                        ...
                        request
                            ...
                            .then((res) => {
                                console.log(registerForm.pState);
                                console.log(res);
                                if (res.data.status != 200)
                                    return this.$message.error(
                                        "用户名或密码错误"
